...
def get_movie_info(movie_info_url):
    ...
    movie_languages = movie_doc.xpath(
        "//*[@id='media_v4']/div/div[2]/div/section/div[1]/div/section[1]/p[3]/text()")  # 语言
    ...
    moive_info = {
        ...
        "电影日期": movie_dates[0].strip() if movie_dates else '',
        ...
        "电影宣传语": movie_slogans[0].strip() if movie_slogans else '',
